...
class MainNet(nn.Module):
    ...
    def forward(self, x):
        ...
        detect_out_13 = self.detect_13(convset_out_13)
        ...
        detect_out_26 = self.detect_26(convset_out_26)
        ...
        detect_out_52 = self.detect_52(convset_out_52)

        return detect_out_13,detect_out_26,detect_out_52
